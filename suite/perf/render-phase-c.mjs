...
const H = read('phaseC-ferrofin.json'), J = read('phaseC-jellyfin.json');
const Hm = read('phaseCmem-ferrofin.json'), Jm = read('phaseCmem-jellyfin.json');
...
const md = `# Ferrofin vs Jellyfin — Phase C (mixed contention + memory footprint)
