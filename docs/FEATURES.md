...
- **`.cbr` / `.cb7` comics** — recognized and browsable, but no embedded metadata or cover is
  extracted: those are RAR and 7z archives, and neither has a maintained pure-Rust reader
