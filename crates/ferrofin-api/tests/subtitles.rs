...
use ferrofin_model::dto::{ItemCounts, MediaSourceInfo};
...
use ferrofin_traits::library::{LibraryManager, MediaSourceManager};
...
impl FileSystem for FontFs {
    fn get_file_system_entries(&self, _path: &str) -> Vec<ferrofin_model::io::FileSystemEntryInfo> {
        unimplemented!("unused")
    }
