//! Quick Connect — pairing enable/initiate/connect + authorize guard.
//!
//! Drives the QuickConnect handlers through `create_router` with injected
//! `ferrofin-traits` fakes that authenticate and return canned data, asserting the
...
use ferrofin_model::dto::{NameIdPair, SessionInfoDto, UserDto};
...
use ferrofin_traits::net::{AuthService, RequestContext};
