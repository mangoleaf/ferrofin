//! `ImageProcessor` — the high-level [`hermit_traits::drawing::ImageProcessor`]
...
//! - `MimeTypes.GetMimeType` is reused from [`hermit_model::net::mime_types`];
//!   `GetMD5().ToString("N")` is reused from [`hermit_common::extensions::get_md5`]
...
use hermit_model::net::mime_types::get_mime_type;
use hermit_traits::drawing::{ImageEncoder, ImageProcessor as ImageProcessorTrait, ProcessedImage};
use hermit_traits::error::ServiceError;
use hermit_traits::options::{ImageCollageOptions, ImageProcessingOptions, ItemImageInfo};
use uuid::Uuid;
...
mod tests {
    ...
    impl ImageEncoder for CountingEncoder {
        ...
        async fn encode_image(
            ...
            output_path: &str,
            _auto_orient: bool,
            _orientation: Option<hermit_model::drawing::ImageOrientation>,
            _quality: i32,
    ...
    async fn no_encoding_support_passes_through() {
        ...
        impl ImageEncoder for NoEncode {
            ...
            async fn encode_image(
                ...
                _o: &str,
                _a: bool,
                _or: Option<hermit_model::drawing::ImageOrientation>,
                _q: i32,
