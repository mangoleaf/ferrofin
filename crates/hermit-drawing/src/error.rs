//! Error type for the `hermit-drawing` crate.
//!
//! The image-processing traits in `hermit-traits` return
...
//! error into [`ServiceError::BackendSource`](hermit_traits::error::ServiceError::BackendSource),
...
/// A backend/infrastructure failure raised inside `hermit-drawing` while
