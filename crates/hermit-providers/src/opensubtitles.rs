...
//! compiled-in Hermit plugin ([`PLUGIN_ID`] / [`PLUGIN_NAME`]) whose credentials
...
use hermit_traits::plugins::PluginManager;
...
const USER_AGENT: &str = concat!("Hermit/", env!("CARGO_PKG_VERSION"));
