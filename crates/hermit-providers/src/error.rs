//! Error type for the `hermit-providers` crate.
//!
//! The provider traits in `hermit-traits` return
...
/// A backend/infrastructure failure raised inside `hermit-providers` while
