//! Static registry of Hermit's compiled-in metadata/image/subtitle/segment
...
/// The item types [`all_metadata_plugins`] enumerates (every type Hermit can
/// attach providers to).
...
mod tests {
    ...
    use hermit_model::configuration::MetadataPluginType;
