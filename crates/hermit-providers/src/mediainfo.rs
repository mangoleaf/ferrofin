...
//!   `&dyn hermit_traits::media_encoding::MediaEncoder` (the ffprobe seam), so
...
use hermit_model::entities::{IsoType, MediaStreamType, Video3DFormat, VideoType};
use hermit_model::entities_media::{ChapterInfo, MediaStream};
...
mod tests {
    ...
    use hermit_model::dto::MediaSourceInfo;
    use hermit_model::entities::{IsoType, MediaStreamType, VideoType};
