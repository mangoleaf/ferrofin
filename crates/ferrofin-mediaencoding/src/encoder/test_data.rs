//! Verbatim `ffmpeg -version` fixtures transliterated from the C# oracle
//! `Jellyfin.MediaEncoding.Tests.EncoderValidatorTestsData`.
#![allow(clippy::doc_markdown)]

/// `FFmpegV701Output` fixture.
pub const FFMPEG_V701_OUTPUT: &str = r"ffmpeg version 7.0.1-Jellyfin Copyright (c) 2000-2024 the FFmpeg developers
...
/// `FFmpegV611Output` fixture.
pub const FFMPEG_V611_OUTPUT: &str = r"ffmpeg version n6.1.1-16-g33efa50fa4-20240317 Copyright (c) 2000-2023 the FFmpeg developers
...
/// `FFmpegV60Output` fixture.
pub const FFMPEG_V60_OUTPUT: &str = r"ffmpeg version 6.0-Jellyfin Copyright (c) 2000-2023 the FFmpeg developers
...
/// `FFmpegV512Output` fixture.
pub const FFMPEG_V512_OUTPUT: &str = r"ffmpeg version 5.1.2-Jellyfin Copyright (c) 2000-2022 the FFmpeg developers
...
/// `FFmpegV44Output` fixture.
pub const FFMPEG_V44_OUTPUT: &str = r"ffmpeg version 4.4-Jellyfin Copyright (c) 2000-2021 the FFmpeg developers
...
/// `FFmpegV432Output` fixture.
pub const FFMPEG_V432_OUTPUT: &str = r"ffmpeg version n4.3.2-Jellyfin Copyright (c) 2000-2021 the FFmpeg developers
...
/// `FFmpegGitUnknownOutput2` fixture.
pub const FFMPEG_GIT_UNKNOWN_OUTPUT2: &str = r"ffmpeg version N-g01fc3034ee-20240317 Copyright (c) 2000-2023 the FFmpeg developers
built with gcc 13.2.0 (crosstool-NG 1.26.0.65_ecc5e41)
...
/// `FFmpegGitWithoutLibpostprocOutput` fixture.
pub const FFMPEG_GIT_WITHOUT_LIBPOSTPROC_OUTPUT: &str = r"ffmpeg version N-122128-gdeadbeef Copyright (c) 2000-2026 the FFmpeg developers
...
/// `FFmpegGitUnknownOutput` fixture.
pub const FFMPEG_GIT_UNKNOWN_OUTPUT: &str = r"ffmpeg version N-45325-gb173e0353-static https://johnvansickle.com/ffmpeg/  Copyright (c) 2000-2018 the FFmpeg developers
