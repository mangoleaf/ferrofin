...
//! their matching `ferrofin-model` DTOs.
//!
//! Only entities with a clean 1:1 `ferrofin-model` target are converted here;
...
//! matched against the C# declaration order that the target `ferrofin-model`
//! enum mirrors.
