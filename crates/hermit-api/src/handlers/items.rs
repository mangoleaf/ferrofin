...
use hermit_traits::options::{AuthorizationInfo, DeleteOptions, DtoOptions, InternalItemsQuery};
use uuid::Uuid;
...
struct ItemsQuery {
    ...
    /// Comma-delimited [`MediaType`](hermit_model::data::MediaType) set.
    #[serde(default)]
    media_types: Option<String>,
    /// Comma-delimited [`ItemSortBy`](hermit_model::live_tv::ItemSortBy) columns.
    #[serde(default)]
    sort_by: Option<String>,
    /// Comma-delimited [`SortOrder`](hermit_model::dto::SortOrder) directions.
    #[serde(default)]
...
fn parse_order_by(
    ...
    Vec<(
        hermit_model::live_tv::ItemSortBy,
        hermit_model::dto::SortOrder,
    )>,
    ApiError,
> {
    use hermit_model::dto::SortOrder;
    let columns: Vec<hermit_model::live_tv::ItemSortBy> = parse_csv_enums(sort_by)?;
