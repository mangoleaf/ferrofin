...
//!   [`ProviderManager::remote_search`](hermit_traits::providers::ProviderManager::remote_search).
...
//! `hermit-providers`), so registering a fetcher yields correct results with no
//! further change here.
//!
...
use hermit_traits::providers::{MetadataRefreshMode, MetadataRefreshOptions, RemoteSearchRequest};
