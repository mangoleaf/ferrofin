...
use hermit_api::test_support::{authed_state_with_library_and_providers, minimal_base_item};
...
use hermit_model::providers::RemoteSearchResult;
...
use hermit_traits::providers::{MetadataRefreshOptions, ProviderManager, RemoteSearchRequest};
...
impl ProviderManager for SearchProviders {
    ...
    async fn queue_refresh(
        ...
        _p: hermit_traits::providers::RefreshPriority,
    ) -> Result<(), ServiceError> {
        unimplemented!()
    }
    ...
    async fn save_image_from_url(
        ...
        _i: Uuid,
        _u: &str,
        _t: hermit_model::entities::ImageType,
        _x: Option<i32>,
    ) -> Result<(), ServiceError> {
        unimplemented!()
    }
    ...
    async fn get_available_remote_images(
        &self,
        _i: Uuid,
        _q: &hermit_model::providers::RemoteImageQuery,
    ...
    async fn save_metadata(
        &self,
        _i: Uuid,
        _u: hermit_traits::providers::ItemUpdateType,
    ) -> Result<(), ServiceError> {
        unimplemented!()
    }
