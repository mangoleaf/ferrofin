...
//! stub `hermit-traits` impls that authenticate and record their calls, asserting
...
use hermit_model::dto::{NameIdPair, SessionInfoDto, UpdateUserItemDataDto, UserItemDataDto};
...
async fn send_full_general_command_is_204() {
    ...
    let command = GeneralCommand {
        name: hermit_model::session::GeneralCommandType::SetVolume,
