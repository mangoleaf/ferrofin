//! [`FerrofinChapterRepository`] — the concrete [`ChapterRepository`] over
//! `ferrofin-db`.
//!
...
#[derive(Clone)]
pub struct FerrofinChapterRepository {
    db: Database,
}

impl std::fmt::Debug for FerrofinChapterRepository {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("FerrofinChapterRepository")
            .finish_non_exhaustive()
    }
}

impl FerrofinChapterRepository {
...
#[async_trait]
impl ChapterRepository for FerrofinChapterRepository {
...
#[cfg(test)]
mod tests {
    use super::FerrofinChapterRepository;
    ...
    async fn save_replaces_and_indexes_in_order() {
        ...
        let repo = FerrofinChapterRepository::new(db);
