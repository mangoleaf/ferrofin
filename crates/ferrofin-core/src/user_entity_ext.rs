//! The C# `User` OOP behavior as free functions over the `ferrofin-db` rows.
//!
...
/// [`DynamicDayOfWeek`](ferrofin_model::users::DynamicDayOfWeek) grouping
...
/// Whether a stored [`DynamicDayOfWeek`](ferrofin_model::users::DynamicDayOfWeek)
