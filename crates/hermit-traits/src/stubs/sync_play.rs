...
//!
//! The concrete impl (`hermit-core`) owns the group registry, the per-group state
//! machine, and broadcasts commands to members via
//! [`SessionMessageBus`](crate::session_bus::SessionMessageBus).

use async_trait::async_trait;
use chrono::{DateTime, Utc};
use hermit_model::sync_play::{GroupInfoDto, GroupQueueMode, GroupRepeatMode, GroupShuffleMode};
use uuid::Uuid;
