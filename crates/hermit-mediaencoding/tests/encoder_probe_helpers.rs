...
use hermit_mediaencoding::encoder::version::FfmpegVersion;
use hermit_mediaencoding::encoder::{EncoderValidator, MAX_VERSION, MIN_VERSION};
use hermit_mediaencoding::probing::InternalMediaInfoResult;
use hermit_mediaencoding::probing::ff_probe_helpers::{
...
fn dtos_de_bool_flexible_accepts_bool_and_strings() {
    ...
    assert_eq!(streams[4].is_avc, None); // unrecognized string
