...
use hermit_traits::media_encoding::{AttachmentExtractor, ExtractedAttachment, MediaEncoder};
...
/// The `hermit-traits` [`AttachmentExtractor`] implementation.
///
...
mod tests {
    ...
    use hermit_traits::error::ServiceError;
    use hermit_traits::media_encoding::{AttachmentExtractor, MediaEncoder, MediaInfoRequest};
    use uuid::Uuid;
    ...
    impl MediaEncoder for FakeEncoder {
        ...
        async fn extract_video_image(
            ...
            _video_stream: &hermit_model::entities_media::MediaStream,
