//! Error type for the `hermit-livetv` crate.
//!
//! The Live TV traits in `hermit-traits` return
...
/// A backend/infrastructure failure raised inside `hermit-livetv` while fetching
