//! [`HermitExternalDataManager`] — the concrete [`ExternalDataManager`].
//!
...
//! map to the hermit-traits members as: `IKeyframeManager.DeleteKeyframeDataAsync`
...
use hermit_traits::system::{ExternalDataManager, PathManager};
...
pub struct HermitExternalDataManager {
...
impl std::fmt::Debug for HermitExternalDataManager {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("HermitExternalDataManager")
            .finish_non_exhaustive()
    }
}

impl HermitExternalDataManager {
...
#[async_trait]
impl ExternalDataManager for HermitExternalDataManager {
...
mod tests {
    ...
    use hermit_traits::media_segments::MediaSegmentProviderInfo;
    ...
    async fn deletes_existing_folders_and_all_db_data() {
        ...
        let mgr = HermitExternalDataManager::with_remover(
            path_manager,
